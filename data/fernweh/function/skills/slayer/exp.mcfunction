scoreboard players add @s[scores={fnw.slay_blaze=1..}] fnw.slayer_xp 1
scoreboard players add @s[scores={fnw.slay_bogged=1..}] fnw.slayer_xp 3
scoreboard players add @s[scores={fnw.slay_breeze=1..}] fnw.slayer_xp 5
scoreboard players add @s[scores={fnw.slay_cave_spider=1..}] fnw.slayer_xp 2
scoreboard players add @s[scores={fnw.slay_creeper=1..}] fnw.slayer_xp 5
scoreboard players add @s[scores={fnw.slay_drowned=1..}] fnw.slayer_xp 2
...
scoreboard players add @s[scores={fnw.slay_hoglin=1..}] fnw.slayer_xp 5
scoreboard players add @s[scores={fnw.slay_husk=1..}] fnw.slayer_xp 3
scoreboard players add @s[scores={fnw.slay_magma_cube=1..}] fnw.slayer_xp 3
scoreboard players add @s[scores={fnw.slay_phantom=1..}] fnw.slayer_xp 3
scoreboard players add @s[scores={fnw.slay_piglin=1..}] fnw.slayer_xp 3
scoreboard players add @s[scores={fnw.slay_piglin_brute=1..}] fnw.slayer_xp 10
scoreboard players add @s[scores={fnw.slay_pillager=1..}] fnw.slayer_xp 5
scoreboard players add @s[scores={fnw.slay_ravager=1..}] fnw.slayer_xp 25
scoreboard players add @s[scores={fnw.slay_shulker=1..}] fnw.slayer_xp 3
scoreboard players add @s[scores={fnw.slay_silverfish=1..}] fnw.slayer_xp 3
scoreboard players add @s[scores={fnw.slay_skeleton=1..}] fnw.slayer_xp 1
scoreboard players add @s[scores={fnw.slay_slime=1..}] fnw.slayer_xp 1
scoreboard players add @s[scores={fnw.slay_spider=1..}] fnw.slayer_xp 1
scoreboard players add @s[scores={fnw.slay_stray=1..}] fnw.slayer_xp 5
scoreboard players add @s[scores={fnw.slay_vex=1..}] fnw.slayer_xp 5
scoreboard players add @s[scores={fnw.slay_vindicator=1..}] fnw.slayer_xp 5
scoreboard players add @s[scores={fnw.slay_witch=1..}] fnw.slayer_xp 5
...
scoreboard players add @s[scores={fnw.slay_zoglin=1..}] fnw.slayer_xp 10
