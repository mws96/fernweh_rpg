...
execute if entity @s[scores={fnw.cube_fragment_scratch=1..}] run tellraw @s [{"text": "1 Cube deducted from your inventory. Teleporting to Mine Base Alpha. ", "color":"blue"},{"text":"This may take a moment...", "color":"gray", "italic":true}]

execute if entity @s[scores={fnw.cube_fragments=10..,fnw.cube_fragment_scratch=0}] run tellraw @s [{"text": "10 Cube Fragments deducted from your balance. Teleporting to Mine Base Alpha. ", "color":"blue"},{"text":"This may take a moment...", "color":"gray", "italic":true}]
