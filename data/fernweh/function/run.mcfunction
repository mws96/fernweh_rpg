...
execute if entity @s[scores={tp_minebasealpha=1..}] run function fernweh:triggers/tp_minebasealpha
execute if entity @s[scores={tp_startervillage=1..}] run function fernweh:triggers/tp_startervillage
